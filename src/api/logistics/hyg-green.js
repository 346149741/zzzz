...
export default {
  ...
  page1(data) {
    return {
      ...
      'data': {
        'content': [
          { 'id': 'a', 'a': '张勇', 'x': '国家级知名专家', 'y': '从事呼吸内科临床、教学及科研工作20余年' },
          { 'id': 'a', 'a': '宋雪勤', 'x': '教授', 'y': '从对呼吸系统急危重症包括重症哮喘、肺源性心...' },
          { 'id': 'a', 'a': '王其华', 'x': '副教授', 'y': '慢性支气管炎、肺气肿、肺心病、肺部感染、...' },
          { 'id': 'a', 'a': '张静', 'x': '副教授', 'y': '专攻呼吸道传染病' },
          { 'id': 'a', 'a': '李民', 'x': '内科主任', 'y': '慢性支气管炎、肺气肿、肺心病、肺部感染、...' },
          { 'id': 'a', 'a': '张慧', 'x': '内科副主任', 'y': '从事呼吸内科临床工作' },
          { 'id': 'a', 'a': '王池永', 'x': '呼吸科医生', 'y': '慢性支气管炎、肺气肿、肺心病、肺部感染、...' },
          { 'id': 'a', 'a': '赵志强', 'x': '呼吸科医生', 'y': '从事呼吸内科临床工作' },
          { 'id': 'a', 'a': '赵民', 'x': '呼吸科医生', 'y': '从事呼吸内科临床工作' },
          { 'id': 'a', 'a': '胡科学', 'x': '呼吸科医生', 'y': '从事呼吸内科临床工作' },
          { 'id': 'a', 'a': '张文勇', 'x': '呼吸科医生', 'y': '从事呼吸内科临床工作' },
          { 'id': 'a', 'a': '钱小瑞', 'x': '呼吸科医生', 'y': '从事呼吸内科临床工作' }
        ],
        'totalElements': 10
      }
    }
