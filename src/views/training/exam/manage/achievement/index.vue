        ...
        >
          <template slot-scope="scope">
            <div class="t-col-operate">
              <i class="el-icon-tickets primary table-i" title="考试详情" @click="handleView(scope.row)" />
            </div>
          </template>
        </el-table-column>
      </el-table>
        ...
        <div class="dialog-item">
          <el-form :model="dataForm" label-width="120px">
            <el-row :gutter="20">
              ...
              <el-col :md="24" :lg="12">
                <el-form-item label="发布人：">{{ dataForm.d }}</el-form-item>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="考试时间：">{{ dataForm.e }}</el-form-item>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="试卷总分：">{{ dataForm.f }}</el-form-item>
              </el-col>
            </el-row>
          </el-form>
        </div>
        <div class="dialog-item-title">考试成绩列表</div>
        <div class="dialog-item">
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <div class="t-col-operate">
                  <i class="el-icon-tickets primary table-i" title="详情"/>
                </div>
              </template>
            </el-table-column>
          </el-table>
...
<script>
  import MeAPI from '@/api/training/exam-achievement'
  export default {
    name: 'Index',
    data() {
      return {
