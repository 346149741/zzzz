        ...
        <el-card class="box-card app-body">
          ...
          <div class="filter-container">
            <el-form :inline="true" class="demo-form-inline">
              ...
              <el-form-item label="应缴团费：" class="filter-item">
                <el-input
              ...
              <el-form-item label="实缴团费：" class="filter-item">
                <el-input
            ...
            <el-table stripe :data="list" class="t-bd" fit highlight-current-row>
              ...
              <el-table-column property="ying" label="应缴团费" />
              <el-table-column property="shi" label="实缴团费" />
