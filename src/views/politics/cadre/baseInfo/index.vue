    ...
    <el-card class="box-card app-body">
      ...
      <div class="filter-container">
        <el-form :inline="true" class="demo-form-inline">
          ...
          <el-form-item label="入伍日期" prop="factoryDate">
            <el-date-picker
      ...
      <el-table v-loading="listLoading" stripe :data="list" class="t-bd" fit highlight-current-row>
        ...
        <el-table-column property="f" label="政治面貌" />
        <el-table-column property="g" label="入伍时间" />
...
<script>
import { deptList } from '../mockData'
import baseCmpt from '../cmpts/baseCmpt'
import eduListCmpt from '../cmpts/eduListCmpt'
import jobListCmpt from '../cmpts/jobListCmpt'
import trainListCmpt from '../cmpts/trainListCmpt.vue'
import contributeListCmpt from '../cmpts/contributeListCmpt.vue'
import familyListCmpt from '../cmpts/familyListCmpt.vue'

export default {
  components: { baseCmpt, eduListCmpt, jobListCmpt, trainListCmpt, contributeListCmpt, familyListCmpt },
  data() {
    return {
      activeName: 'base',
      title: '编辑',
