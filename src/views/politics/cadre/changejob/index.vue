  ...
  <div class="app-container">
    <el-card class="box-card app-body">
      ...
      <el-table v-loading="listLoading" stripe :data="list" class="t-bd" fit highlight-current-row>
        ...
        <el-table-column property="e" label="军衔" />
        <el-table-column property="f" label="退役类型" />
        <el-table-column property="g" label="申请时间" />
        <el-table-column property="h" label="审批状态" />
        <el-table-column property="i" label="审批日期" />
    ...
    >
      <el-tabs v-model="activeName" type="card" class="card-main">
        <el-tab-pane label="基本信息" name="base">
          <baseCmpt :form="{}" />
          <div class="dialog-item-title">退役信息</div>
          <div class="dialog-item">
            <el-form ref="ruleForm" :model="form" label-width="120px" style="overflow: hidden">
              <el-col :md="24" :lg="12">
                <el-form-item label="退役类型：" prop="sex">
                  <el-select v-model="form.sex" class="form-item1" placeholder="请选择原因">
                    <el-option label="复原" value="男" />
                    <el-option label="转业" value="女" />
                    <el-option label="退休" value="女" />
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="退役原因：" prop="sex">
                  <el-input v-model="form.name" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="材料上传：" prop="name">
...
import jobListViewCmpt from '../cmpts/jobListViewCmpt'
import trainListViewCmpt from '../cmpts/trainListViewCmpt'
import contributeListViewCmpt from '../cmpts/contributeListViewCmpt'
import familyListViewCmpt from '../cmpts/familyListViewCmpt'
export default {
