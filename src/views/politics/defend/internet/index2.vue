<template>
  ...
  <div>
    ...
    <div class="filter-container">
      <el-form :inline="true" class="demo-form-inline">
        <el-form-item class="filter-item">
          <el-input v-model="dataForm.name" placeholder="请输入单位名称或域名或备案号查询" style="width: 250px" />
    ...
    >
      ...
      <el-table-column label="主办单位名称" fixed show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ scope.row.a }}</span>
        </template>
      </el-table-column>
      <el-table-column label="主办单位性质" fixed show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ scope.row.b }}</span>
        </template>
      </el-table-column>
      <el-table-column label="备案/许可证号" fixed show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ scope.row.c }}</span>
        </template>
      </el-table-column>
      <el-table-column label="网站名称" fixed show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ scope.row.d }}</span>
        </template>
      </el-table-column>
      <el-table-column label="网站域名" show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ scope.row.e }}</span>
        </template>
      </el-table-column>
      <el-table-column label="审核通过时间" show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ scope.row.f }}</span>
        </template>
      </el-table-column>
      <el-table-column label="是否限制介入" show-overflow-tooltip>
        <template slot-scope="scope">
        ...
        <div class="dialog-item">
          <el-form ref="dataForm" :model="dataForm" :rules="rules" label-width="140px">
            <el-row :gutter="20">
              ...
              <el-col :md="24" :lg="12">
                <el-form-item label="主办单位名称：" prop="a">
                  <el-input v-model="dataForm.a" class="form-item1" placeholder="案例编号由系统自动生成" />
                </el-form-item>
              </el-col>

              <el-col :md="24" :lg="12">
                <el-form-item label="主办单位性质：" prop="b">
                  <el-input v-model="dataForm.b" class="form-item1" placeholder="请输入主办单位性质" />
                </el-form-item>
              </el-col>

              <el-col :md="24" :lg="12">
                <el-form-item label="备案/许可证号：" prop="c">
                  <el-input v-model="dataForm.c" class="form-item1" placeholder="请输入备案/许可证号" />
                </el-form-item>
              </el-col>

              <el-col :md="24" :lg="12">
                <el-form-item label="审核通过时间：" prop="d">
                  <el-input v-model="dataForm.d" class="form-item1" placeholder="请输入审核通过时间" />
                </el-form-item>
              </el-col>
              ...
              <el-col :md="24" :lg="12">
                <el-form-item label="网站名称：" prop="e">
                  <el-input v-model="dataForm.e" class="form-item1" placeholder="请输入网站名称" />
                </el-form-item>
              </el-col>

              <el-col :md="24" :lg="12">
                <el-form-item label="网站域名：" prop="f">
                  <el-input v-model="dataForm.f" class="form-item1" placeholder="请输入网站域名" />
                </el-form-item>
              </el-col>

              <el-col :md="24" :lg="12">
                <el-form-item label="网站首页：" prop="g">
                  <el-input v-model="dataForm.g" class="form-item1" placeholder="请输入网站首页" />
                </el-form-item>
              </el-col>

              <el-col :md="24" :lg="12">
                <el-form-item label="网站前置审批项：" prop="h">
                  <el-input v-model="dataForm.h" class="form-item1" placeholder="请输入网站前置审批项" />
                </el-form-item>
              </el-col>

              <el-col :md="24" :lg="12">
                <el-form-item label="是否限制接入：" prop="i">
                  <el-input v-model="dataForm.i" class="form-item1" placeholder="请输入是否限制接入" />
                </el-form-item>
              </el-col>
        ...
        <div class="dialog-item">
          <el-form :model="dataForm" label-width="140px">
            <el-row :gutter="20">
              <el-divider><span style="font-size: 18px;font-weight: 700;">备案主体信息</span></el-divider>
              <el-col :md="24" :lg="12">
                <el-form-item label="主办单位名称：">{{ dataForm.a }}</el-form-item>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="主办单位性质：">{{ dataForm.b }}</el-form-item>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="备案/许可证号：">{{ dataForm.c }}</el-form-item>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="审核通过时间：">{{ dataForm.f }}</el-form-item>
              </el-col>
              <el-col :md="24" :lg="24">
                <el-divider><span style="font-size: 18px;font-weight: 700;">备案网站信息</span></el-divider>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="网站名称：">{{ dataForm.d }}</el-form-item>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="网站域名：">{{ dataForm.e }}</el-form-item>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="网站首页：">{{ dataForm.j }}</el-form-item>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="网站前置审批项：">{{ dataForm.h }}</el-form-item>
              </el-col>
              <el-col :md="24" :lg="12">
                <el-form-item label="是否限制接入：">{{ dataForm.i }}</el-form-item>
              </el-col>
            </el-row>
          </el-form>
        </div>
