  ...
  <div class="app-container">
    <el-card class="box-card app-body">
      ...
      >
        ...
        <el-table-column align="center" label="违章日期" prop="joinTime" />
        <el-table-column align="center" label="违章地点" prop="address" />
        <el-table-column align="center" label="扣分" prop="unit" />
        <el-table-column align="center" label="罚款" prop="monty" />
        ...
        <div class="dialog-item">
          <el-form ref="dataForm" :model="dataForm" :rules="rules" label-width="130px">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="处理号" prop="itemName">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="处理单位 : " class="filter-item">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="定损人 : " class="filter-item">
                  <el-input v-model="dataForm.dsr" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="责任认定 : " class="filter-item">
                  <el-input v-model="dataForm.zrrd" class="form-item1" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="事故说明 : " class="filter-item">
                  <el-input v-model="dataForm.sgsm" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="事故地点 : " class="filter-item">
                  <el-input v-model="dataForm.sgdd" class="form-item1" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col>
                <el-form-item label="修理地点 : " class="filter-item">
            ...
            <el-row>
              <el-col>
                <el-form-item label="处理情况 : " class="filter-item">
                  <el-input v-model="dataForm.clqk" type="textarea" />
                </el-form-item>
              </el-col>
            </el-row>
      ...
      <div class="dialog-content">
        <div class="dialog-item">
          <el-form ref="lookForm" label-width="130px">
            ...
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="违章日期: " class="filter-item">{{ lookForm.rq }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
            ...
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="扣分: " class="filter-item">{{ lookForm.unit }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="罚款: " class="filter-item">{{ lookForm.monty }}</el-form-item>
              </el-col>
            </el-row>
