  ...
  <div class="app-container">
    <el-card class="box-card app-body">
      ...
      >
        ...
        <el-table-column align="center" label="车辆品牌" prop="clpp" />
        <el-table-column align="center" label="车辆类型" prop="carType" />
        <el-table-column label="故障描述" prop="sgdj" />
        <el-table-column align="center" label="申请人" prop="classify" />
        <el-table-column align="center" label="申请人电话" prop="pic" />
        <el-table-column align="center" width="180px" label="申请日期" prop="joinTime" />
      ...
      <div class="dialog-content">
        <div class="dialog-item">
          <el-form ref="dataForm" :model="dataForm" :rules="rules" label-width="130px">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="申请人部门" prop="xlbm">
                  <el-select
                    v-model="dataForm.bm"
                    class="filter-item"
                    placeholder="请选择"
              ...
              <el-col :span="12">
                <el-form-item label="申请人姓名 : " class="filter-item" prop="jsr">
                  <el-input v-model="dataForm.jsr" class="form-item1" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="联系电话 : " class="filter-item" prop="dianhua">
                  <el-input v-model="dataForm.dianhua" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="故障开始日期 : " class="filter-item" prop="qcrq">
                  <el-date-picker
                    v-model="listQuery.params.qcrq"
                    style="width:100%"
                    type="date"
                    placeholder="选择日期"
                  />
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="故障描述 : " class="filter-item" prop="sxyy">
                  <el-input v-model="dataForm.sxyy" type="textarea" class="form-item1" />
                </el-form-item>
              </el-col>
            </el-row>
      ...
      <div class="dialog-content">
        <div class="dialog-item">
          <el-form ref="lookForm" label-width="130px">
            ...
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="车辆品牌: " class="filter-item">{{ lookForm.clpp }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="车辆类型: " class="filter-item">{{ lookForm.carType }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="故障描述: " class="filter-item">{{ lookForm.sgdj }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
            ...
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="申请日期: " class="filter-item">{{ lookForm.rq }}</el-form-item>
              </el-col>
            </el-row>
            <!-- <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="审核状态: ">{{ lookForm.status }}</el-form-item>
              </el-col>
            </el-row> -->
          </el-form>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      imageUrl1:
        'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1600592935028&di=e14f8a1be7db7004234a7b5d15baa123&imgtype=0&src=http%3A%2F%2Fn.sinaimg.cn%2Fsinacn%2F20170318%2F2b76-fycnyhk8790601.jpg',
      tableKey: 0,
      listArr: [
        {
          id: 'HY12345',
      ...
      rules: {
        ...
        jsr: [{ required: true, message: '申请人不能为空', trigger: 'blur' }],
        qcrq: [
          { required: true, message: '故障开始不能为空', trigger: 'blur' }
        ],
        dianhua: [
  ...
  methods: {
    ...
    handleView(row) {
      ...
      this.lookForm.clpp = row.clpp
      this.lookForm.carType = row.carType
      this.lookForm.status = row.status
