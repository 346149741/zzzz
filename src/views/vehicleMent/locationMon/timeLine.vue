<template>
  ...
  <div style="display:flex;">
    <!-- 当日志记录不超过9个，全排列 -->
    <div v-if="timeLineList.length<9" class="container">
      <div style="display:flex;">
        <div style="flex:1;display:flex;flex-direction:column;">
          <div style="flex:1;display:flex">
            ...
            <el-tooltip effect="light" placement="top-start">
              ...
              <div class="dot" :class="{active: 0 === timeIndex}" @mouseover="changeActive(0)" />
            </el-tooltip>
        ...
        <div v-for="(item,index) in timeLineList" v-if="index>0 && index<timeLineList.length-1" :key="index" style="flex:1;display:flex;flex-direction:column;">
          <div style="flex:1;display:flex">
            <div class="item" />
            <el-tooltip effect="light" placement="top">
              <div slot="content">{{ timeLineList[index].info }}</div>
              <div class="dot" :class="{active: index === timeIndex}" @mouseover="changeActive(index)" />
            </el-tooltip>
            <div class="item" />
          </div>
          <div class="item_bottom">
        ...
        <div style="flex:1;display:flex;flex-direction:column;">
          <div style="flex:1;display:flex">
            ...
            <el-tooltip effect="light" placement="top-end">
              ...
              <div class="dot" :class="{active: timeLineList.length-1 === timeIndex}" @mouseover="changeActive(timeLineList.length-1)" />
            </el-tooltip>
            <div style="flex:1;" />
          </div>
          <div class="item_bottom">
    ...
    <div v-else class="container">
      <div style="display:flex;">
        <div style="flex:1;display:flex;flex-direction:column">
          <div style="flex:1;display:flex;">
            <div style="flex:1;" />
            <div class="move-button el-icon-arrow-left" :class="{active: left_button_active}" :disabled="left_button_disabled" @click="moveLeft()" />
            <div class="item" />
          </div>
          <div class="item_bottom">
        ...
        <div v-for="(item,index) in timeLineList" v-if="index > point && index <= point_end" :key="index" style="flex:1;display:flex;flex-direction:column;">
          <div style="flex:1;display:flex">
            <div class="item" />
            <el-tooltip effect="light" placement="top">
              <div slot="content">{{ timeLineList[index].info }}</div>
