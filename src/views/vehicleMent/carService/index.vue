    ...
    <el-card class="box-card app-body">
      ...
      <div class="filter-container">
        <el-form :inline="true" class="demo-form-inline">
          ...
          <el-form-item label="送修日期 : " class="filter-item">
            <el-date-picker
          ...
          <el-form-item label="取车日期 : " class="filter-item">
            <el-date-picker
      ...
      >
        ...
        <el-table-column label="送修原因" prop="sgdj" />
        <el-table-column align="center" label="送修日期" prop="sxrq" />
        <el-table-column align="center" label="取车日期" prop="joinTime" />
        <el-table-column align="center" label="修理厂" prop="unit" />
        <el-table-column align="center" label="经手人" prop="classify" />
      ...
      <div class="dialog-content">
        <div class="dialog-item">
          <el-form ref="dataForm" :model="dataForm" :rules="rules" label-width="130px">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="送修日期 : " class="filter-item" prop="sxrq">
                  <el-date-picker
                    v-model="listQuery.params.sxrq"
                    style="width:100%"
                    type="date"
                    placeholder="选择日期"
                  />
              ...
              <el-col :span="12">
                <el-form-item label="修理部门" prop="xlbm">
                  <el-input v-model="dataForm.xlbm" class="form-item1" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="经手人 : " class="filter-item" prop="jsr">
                  <el-input v-model="dataForm.jsr" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="取车日期 : " class="filter-item" prop="qcrq">
                  <el-date-picker
                    v-model="listQuery.params.qcrq"
                    style="width:100%"
                    type="date"
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="送修原因 : " class="filter-item" prop="sxyy">
                  <el-input v-model="dataForm.sxyy" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="修理厂电话 : " class="filter-item">
      ...
      <div class="dialog-content">
        <div class="dialog-item">
          <el-form ref="lookForm" label-width="130px">
            ...
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="送修原因: " class="filter-item">{{ lookForm.sgdj }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="送修日期: " class="filter-item">{{ lookForm.sxrq }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="取车日期: " class="filter-item">{{ lookForm.rq }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="修理厂: " class="filter-item">{{ lookForm.unit }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="经手人: ">{{ lookForm.username }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="备注: ">{{ lookForm.bz }}</el-form-item>
              </el-col>
            </el-row>
          </el-form>
        </div>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        xlbm: [
          { required: true, message: '修理部门不能为空', trigger: 'blur' }
        ],
        jsr: [
          { required: true, message: '经手人不能为空', trigger: 'blur' }
        ],
        qcrq: [
          { required: true, message: '取车日期不能为空', trigger: 'blur' }
        ],
        sxyy: [
