    ...
    <el-card class="box-card app-body">
      ...
      <div class="filter-container">
        <el-form :inline="true" class="demo-form-inline">
          ...
          <el-form-item label="年检日期 : " class="filter-item">
            <el-date-picker
          ...
          <el-form-item label="到期日期 : " class="filter-item">
            <el-date-picker
      ...
      >
        ...
        <el-table-column label="违章类型" prop="sgdj" />
        <el-table-column align="center" label="年检日期" prop="sxrq" />
        <el-table-column align="center" label="到期日期" prop="joinTime" />
        <el-table-column align="center" label="车管所" prop="unit" />
        <el-table-column align="center" label="年检费用(元)" prop="monty" />
      ...
      <div class="dialog-content">
        <div class="dialog-item">
          <el-form ref="dataForm" :model="dataForm" :rules="rules" label-width="130px">
            ...
            <h4 class="title">年检记录</h4>
            <el-row>
              <el-col :span="12">
                <el-form-item label="年检日期 : " class="filter-item" prop="sxrq">
                  <el-date-picker
              ...
              <el-col :span="12">
                <el-form-item label="年检号" prop="xlbm">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="年检费用 : " class="filter-item" prop="sxyy">
                  <el-input v-model="dataForm.sxyy" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="车管所 : " class="filter-item" prop="cgs">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="到期日期 : " class="filter-item" prop="qcrq">
                  <el-date-picker
                    v-model="listQuery.params.qcrq"
                    style="width:100%"
                    type="date"
      ...
      <div class="dialog-content">
        <div class="dialog-item">
          <el-form ref="lookForm" label-width="130px">
            ...
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="违章类型: " class="filter-item">{{ lookForm.sgdj }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="年检日期: " class="filter-item">{{ lookForm.sxrq }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="到期日期: " class="filter-item">{{ lookForm.rq }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
                <el-form-item label="车管所: " class="filter-item">{{ lookForm.unit }}</el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :md="24" :lg="20">
