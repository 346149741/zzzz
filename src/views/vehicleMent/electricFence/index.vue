...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        bm: [{ required: true, message: "请选择启用状态", trigger: "change" }],
        sxrq: [
          { required: true, message: "监测开始时间不能为空", trigger: "blur" },
        ],
        xlbm: [{ required: true, message: "名称不能为空", trigger: "blur" }],
        jsr: [{ required: true, message: "经手人不能为空", trigger: "blur" }],
        qcrq: [
