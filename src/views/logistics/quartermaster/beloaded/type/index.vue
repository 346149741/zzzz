      ...
      <el-col :span="12">
        <el-card class="box-card app-body">
          ...
          >
            ...
            <el-table-column label="被装类别标识" show-overflow-tooltip>
              <template slot-scope="scope">
                <span>{{ scope.row.code }}</span>
              </template>
            </el-table-column>
            <el-table-column label="被装类别名称" show-overflow-tooltip>
              <template slot-scope="scope">
    ...
    >
      <div class="dialogBox">
        <el-form
          ...
          label-width="120px"
        >
          <el-form-item label="被装类型标识" prop="code">
            <el-input v-model="dictTypeForm.code" placeholder="请输入被装类型标识" />
          </el-form-item>
          <el-form-item label="被装类型名称" prop="name">
            <el-input v-model="dictTypeForm.name" placeholder="请输入被装类型名称" />
          </el-form-item>
...
const AAA = [
  {
    code: '1001',
    id: '4028b2f86cdb1728016cdb1758dc0008',
    name: '礼服',
    remark: ''
  }, {
    code: '1002',
    id: '4028b2f86cdb1728016cdb1758dc0001',
    name: '常服',
    remark: ''
  }, {
    code: '1003',
    id: '4028b2f86cdb1728016cdb1758dc0002',
    name: '作训服',
    remark: ''
  }, {
    code: '1004',
    id: '4028b2f86cdb1728016cdb1758dc0012',
    name: '棉(皮)大衣',
    remark: ''
  }, {
    code: '1005',
    id: '4028b2f86cdb1728016cdb1758dc0013',
    name: '衬衣',
    remark: ''
  }
]
const BBB = [
  {
    code: '1001',
    id: '4028b2f86cdb1728016cdb1758dc0003',
    name: '夏男S',
    remark: ''
  }, {
    code: '1002',
  ...
  {
    code: '1003',
    id: '4028b2f86cdb1728016cdb1758dc0023',
    name: '夏男L',
    remark: ''
  },
  {
    code: '1004',
    id: '4028b2f86cdb1728016cdb1758dc0033',
    name: '夏女S',
    remark: ''
  },
  {
    code: '1005',
    id: '4028b2f86cdb1728016cdb1758dc0043',
    name: '夏女M',
    remark: ''
  }
]
export default {
  ...
  data() {
    ...
    return {
      ...
      dictTypeRules: {
        code: [
          { required: true, message: '请填写被装类型标识符', trigger: 'blur' },
          { validator: validateDictTypeCode, trigger: 'blur' }
        ],
        name: [
          { required: true, message: '请填写被装类型别名', trigger: 'blur' }
        ]
      },
      dictItemRules: {
        code: [
          { required: true, message: '请填写号型类别标识码', trigger: 'blur' },
          { validator: validateDictItemCode, trigger: 'blur' }
        ],
        value: [
          { required: true, message: '请填写号型详情值', trigger: 'blur' }
        ],
        name: [
          { required: true, message: '请填写号型详情名称', trigger: 'blur' }
        ]
      }
    }
  },
  ...
  methods: {
    ...
    dictTypePage() {
      ...
      this.dictTypeList = AAA
      this.dictTypeTotal = AAA.length
