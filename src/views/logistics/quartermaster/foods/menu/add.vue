  ...
  <div class="app-container">
    <el-card class="box-card app-body">
      ...
      <el-table v-loading="listLoading" stripe :data="list" class="t-bd" fit highlight-current-row>
        ...
        <el-table-column property="c" label="星期" />
        <el-table-column property="d" label="早餐" />
        <el-table-column property="e" label="午餐" />
        <el-table-column property="f" label="晚餐" />
        <el-table-column property="g" label="宵夜" />
        <el-table-column property="h" label="状态" />
        ...
        <div class="dialog-item">
          <el-form :model="form" label-position="right" label-width="120px">
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="星期：">{{ form.c }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="早餐：">{{ form.d }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="午餐：">{{ form.e }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="晚餐：">{{ form.f }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="宵夜：">{{ form.g }}</el-form-item>
              </el-col>
            </el-row>
          </el-form>
        </div>
