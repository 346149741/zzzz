  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column label="职务工资" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>{{ scope.row.d }}</span>
          </template>
        </el-table-column>
        <el-table-column label="军衔工资" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>{{ scope.row.e }}</span>
          </template>
        </el-table-column>
        <el-table-column label="军龄工资" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>{{ scope.row.f }}</span>
          </template>
        </el-table-column>
        <el-table-column label="军人职业津贴" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>{{ scope.row.h }}</span>
          </template>
        </el-table-column>
        <el-table-column label="福利津贴" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>{{ scope.row.h }}</span>
          </template>
        </el-table-column>
        <el-table-column label="防暑降温" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>{{ scope.row.g }}</span>
          </template>
        </el-table-column>
        <el-table-column label="工勤费" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>{{ scope.row.h }}</span>
          </template>
        </el-table-column>
        <el-table-column label="离休干部荣誉" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>{{ scope.row.i }}</span>
          </template>
        </el-table-column>
        <el-table-column label="独生子女奖励" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>{{ scope.row.j }}</span>
          </template>
        </el-table-column>
        <el-table-column label="子女保教补助" width="130" show-overflow-tooltip>
          <template slot-scope="scope">
        ...
        <div class="dialog-item">
          <el-form :model="form" label-position="right" label-width="120px">
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="基本工资：">{{ form.c }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="职务工资：">{{ form.d }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="军衔工资：">{{ form.e }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="军龄工资：">{{ form.f }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="军人职业津贴：">{{ form.h }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="福利津贴：">{{ form.h }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="防暑降温：">{{ form.i }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="工勤费：">{{ form.j }}</el-form-item>
              </el-col>

              <el-col :span="12">
                <el-form-item label="离休干部荣誉：">{{ form.k }}</el-form-item>
              </el-col>

              <el-col :span="12">
                <el-form-item label="独生子女奖励：">{{ form.l }}</el-form-item>
              </el-col>

              <el-col :span="12">
                <el-form-item label="子女保教补助：">{{ form.m }}</el-form-item>
              </el-col>
            </el-row>
          </el-form>
        </div>
        ...
        <div class="dialog-item">
          <el-form :model="form" label-position="right" label-width="120px">
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="防暑降温：">
                  <el-input v-model="form.g" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="工勤费：">
                  <el-input v-model="form.h" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="离休干部荣誉：">
                  <el-input v-model="form.i" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="独生子女奖励：">
                  <el-input v-model="form.j" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="子女保教补助：">
                  <el-input v-model="form.k" class="form-item1" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
