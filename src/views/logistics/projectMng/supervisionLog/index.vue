    ...
    <el-card class="box-card app-body">
      ...
      <div class="filter-container">
        <el-form :inline="true" class="demo-form-inline">
          <el-form-item label="工程名称：" class="filter-item">
            <el-input
          ...
          <el-form-item label="施工单位：" class="filter-item">
            <el-input
              v-model="listQuery.params.a"
              type="text"
              class="filter-item"
          ...
          <el-form-item label="监理单位：" class="filter-item">
            <el-input
          ...
          <el-form-item label="监理时间：" class="filter-item">
            <el-date-picker
              is-range
      ...
      <el-table v-loading="listLoading" stripe :data="list" class="t-bd" fit highlight-current-row>
        ...
        <el-table-column property="a" label="工程名称" />
        <el-table-column property="b" label="施工单位" />
        <el-table-column property="c" label="监理单位" />
        <el-table-column property="d" label="监理工程师" />
        <el-table-column property="e" label="监理时间" />
        <el-table-column property="f" show-overflow-tooltip label="检查记录" />
        ...
        <div class="dialog-item">
          <el-form :model="form" label-position="right" label-width="120px">
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="工程名称：">{{ form.a }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="施工单位：">{{ form.b }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="监理单位：">{{ form.c }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="监理工程师：">{{ form.d }}</el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="检查记录：">{{ form.f }}</el-form-item>
              </el-col>
            </el-row>
          </el-form>
        </div>
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="24">
                <el-form-item label="检查记录：">
                  <el-input
                    type="textarea"
                    v-model="form.f" class="form-item1" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
      ...
      list: [
        {
          ...
          d: '张三',
          e: '2019-12-24',
          f: '1、人防区底板钢筋及基础梁钢筋绑扎符合规范要求\n' +
            '2、梁板结构人防区底板板面筋符合反梁构造要求\n' +
            '3、底板钢筋规格、间距和有效高度满足设计要求',
        }
      ],
      form: {
        a: '',
