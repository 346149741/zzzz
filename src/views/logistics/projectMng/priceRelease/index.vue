  ...
  <div class="app-container">
    <el-card class="box-card app-body">
        ...
        <el-form :inline="true" class="demo-form-inline">
          <el-form-item label="用途：" class="filter-item">
            <el-select
              ...
              placeholder="请选择用途"
            >
              <el-option v-for="item in typeList" :label="item.value" :value="item.key" />
            </el-select>
          </el-form-item>
          <el-form-item label="物品名称：" class="filter-item">
            <el-input
          ...
          <el-form-item label="信息价：" class="filter-item">
            <el-input
      ...
      <el-table v-loading="listLoading" stripe :data="list" class="t-bd" fit highlight-current-row>
        ...
        <el-table-column property="a" label="分类" />
        <el-table-column property="b" label="设备名称" />
        <el-table-column property="c" label="属性组合" />
        <el-table-column property="d" label="单位" />
        <el-table-column property="e" label="信息价(元)" />
        <el-table-column property="f" label="信息价(元,不含税)" />
        <el-table-column property="g" label="价格时间" />
        ...
        <div class="dialog-item">
          <el-form :model="form" label-position="right" label-width="140px">
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="分类：">{{ form.a }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="物品名称：">{{ form.b }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="属性组合：">{{ form.c }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="单位：">{{ form.d }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="信息价(元)：">{{ form.e }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="信息价(元/不含税)：">{{ form.f }}</el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="价格时间：">{{ form.g }}</el-form-item>
              </el-col>
            </el-row>
          </el-form>
        </div>
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="分类：">
                  <el-select v-model="form.a" class="form-item1" placeholder="请选择分类">
                    <el-option v-for="item in typeList" :label="item.value" :value="item.key" />
                  </el-select>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12">
                <el-form-item label="信息价(元)：">
                  <el-input v-model="form.e" class="form-item1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="信息价(元/不含税)：">
