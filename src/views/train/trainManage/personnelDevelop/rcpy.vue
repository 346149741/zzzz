      ...
      <div class="dialog-content">
        <div class="dialog-item">
          ...
          >
            <el-row :gutter="20">
              <el-col :span="24">
                <el-form-item label="主题：">关于培养一批高层次人才的计划通知</el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="人才类型：">
                  高层次人才
              ...
              <el-col :span="24">
                <el-form-item label="发布单位：">第129师</el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="内容：">接上级通知，结合我师实际情况，为了庆祝本次训练考核顺利结束，
                  特安排通知需要培养一批高层次人才</el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="评选时间：">2020-09-10</el-form-item>
              </el-col>
            </el-row>
          </el-form>
        </div>
      ...
      transferdata: [
        {
          ...
          key: 0,
          time: "4'15″",
          url: 'http://music.163.com/song/media/outer/url?id=145754.mp3'
        },
        {
          label: '歌唱祖国-东方红合唱团',
          type: 'mp3',
          key: 1,
          time: "3'08″",
          url: 'http://music.163.com/song/media/outer/url?id=5234256.mp3'
        },
        {
          label: '中国人民解放军进行曲',
          type: 'mp3',
          key: 2,
          time: "3'05″",
          url: 'http://music.163.com/song/media/outer/url?id=1304301596.mp3'
        }
      ],
      list: [
        {
          title: '关于培养一批高层次人才的计划通知',
          fbsj: '2020-09-16',
          pxsj: '2020-08-16',
          fbdw: '第129师',
          rclx: '高层次人才'
