<template>
  <div>
    <div class="box-div">
      <el-row :gutter="20" style="display: flex;justify-content: space-between;margin-bottom: 21px;">
        <div class="box-box"><span>33</span><span>考核次数</span></div>
        <div class="box-box"><span>184</span><span>参考人数</span></div>
        <div class="box-box"><span>100</span><span>及格人数</span></div>
        <div class="box-box"><span>84</span><span>不及格人数</span></div>
        <div class="box-box"><span>98%</span><span>及格率</span></div>
      </el-row>
      <el-row :gutter="20">
        <el-col
          :md="24"
  ...
  series: [
    {
      ...
      type: 'line',
      stack: '比例',
      data: [20, 30, 40, 38, 52, 66, 78, 42, 38, 56, 62, 42]
    },
    {
      name: '良好率',
      type: 'line',
      stack: '比例',
      data: [56, 42, 84, 75, 54, 69, 53, 74, 85, 43, 57, 45]
    },
    {
      name: '及格率',
      type: 'line',
      stack: '比例',
      data: [85, 78, 92, 81, 88, 95, 99, 86, 93, 76, 87, 86]
    }
  ]
}
const option10 = {
  ...
  series: [
    {
      data: [23, 25, 30, 45, 36, 48, 27, 52, 36, 41, 23, 30],
      type: 'line',
      areaStyle: {
        normal: {}
      }
...
/deep/ .box-box span:nth-last-child(1){
  flex-basis: 100%;
    text-align: center;
}
/deep/ .box-box span:first-child{
    font-size: 40px;
}
